...
<body>
            ...
            @include('admin.include.nav')
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Manage Category /</span>
                            Add Category</h4>
                                            ...
                                            <div class="row">
                                                <div class="mb-3 col-md-12">
                                                    <input class="form-control" type="text" id="short_desc" name="short_desc"
                                                        value="" placeholder="Enter Short Description" />
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="mb-3 col-md-4">
                                            <button class="btn btn-primary btn-lg" type="submit"
                                                name="submitBtn" id="submitBtn">Add Catgeory</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    $('#addCategory').on('submit', function(e) {
        ...
        axios.post(`${url}/admin/category/add`, new FormData(this)).then(function(response) {
            // handle success
