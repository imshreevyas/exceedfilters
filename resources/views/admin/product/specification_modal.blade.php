<div class="modal fade" id="specificationModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <h4>All Assets</h4>
                                <div id="sepcificationsData" class="assetsData"></div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-outline-secondary" onclick="closeModal('specificationModal')">
                                Close
                            </button>
                        </div>
                </div>
